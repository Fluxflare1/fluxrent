...
export async function POST(req: Request) {
  try {
    ...
    const tpl = await addTemplate({ id: `tpl_${Date.now()}`, name: filename, drive_link: driveFile.webViewLink || driveFile.webContentLink || `https://drive.google.com/file/d/${driveFile.id}/view` })
