// frontend/app/api/tenants/route.ts
import { NextResponse } from "next/server";
import { getTenants, addTenant, googleSheets, getSheets, ensureSheetTabs } from "../../../lib/googleSheets";
...
export async function POST(req: Request) {
  try {
    ...
    // Auto-assign apartment if provided
    if (apartment_id) {
