...
import { generateMonthlyBillsForProperty } from '../../../../lib/googleSheets'
...
export async function POST(req: Request) {
  try {
    ...
    const created = await generateMonthlyBillsForProperty(body.property_id, body.period, body.due_day || 5)
