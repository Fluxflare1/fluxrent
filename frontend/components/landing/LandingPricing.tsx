    ...
    <section id="pricing" className="px-8 py-20 bg-gray-50 text-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
        ...
        <div className="bg-white border rounded-lg shadow-lg p-8">
          ...
          <p className="text-4xl font-extrabold mb-6">$29<span className="text-lg">/mo</span></p>
        ...
        <div className="bg-blue-900 text-white border rounded-lg shadow-lg p-8">
          ...
          <a href="/contact" className="bg-yellow-400 text-blue-900 px-6 py-3 rounded-lg font-semibold hover:bg-yellow-300">
            Contact Sales
          </a>
        </div>
      </div>
